    ...
    <div class="container-fluid mt--9">
        <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
                <a href="{{ route('container.create') }}" class="btn btn-sm btn-neutral">New <i class="fa fa-plus fa-sm"></i></a>
                    ...
                    <div class="card-header border-0">
                        <div class="row">
                            <div class="col-md-6 mt-2">
                                <h3 class="mb-0">List Container</h3>
                            </div>
                            <div class="col-md-6 mt-2">
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            <thead class="thead-light">
                                <tr>
                                    <th scope="col" class="sort" data-sort="name">Nama Container</th>
                            ...
                            <tbody class="list">
                                @foreach ($items as $item)
                                    <tr>
                                        <th scope="row">
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    <span class="name mb-0 text-sm">{{$item->container_name}}</span>
                                                </div>
                                            </div>
                                        </th>
                                        <td>
                                        ...
                                        <td class="text-left">
                                            <a href="{{ route('container.edit', $item->id) }}" class="btn btn-warning">
                                                <i class="fa fa-pen"></i>
                                            </a>
                                            <button class="btn btn-danger btn" wire:click="deleteContainer({{$item->id}})">
