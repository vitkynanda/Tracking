                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            <thead class="thead-light">
                                <tr>
                                    <th scope="col" class="sort" data-sort="name">Informasi</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->delivery_status == 1)
                                                <span class="badge badge-info"><i class="fa fa-cloud-download-alt fa-sm mr-2"></i> Tiba di {{$item->origin_name}}</span>                                                      
