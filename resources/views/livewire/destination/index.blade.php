    ...
    <div class="container-fluid mt--9">
        <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
                <a href="{{ route('destination.create') }}" class="btn btn-sm btn-neutral">New <i class="fa fa-plus fa-sm"></i></a>
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            <thead class="thead-light">
                                <tr>
                                    <th scope="col" class="sort" data-sort="name">Nama Tujuan</th>
                                    <th scope="col" class="sort" data-sort="name">Alamat Tujuan</th>
                                        ...
                                        <th scope="row">
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-body">
                                                    <span class="name mb-0 text-sm">{{$item->destination_name}}</span>
                                                </div>
                                            </div>
                                        </th>
                                        <td>
