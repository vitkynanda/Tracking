    ...
    <div class="container-fluid mt--9">
        <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
                ...
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                    <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                        <li class="breadcrumb-item"><a href="{{ route('good.index') }}"><i class="fas fa-home"></i></a></li>
            ...
            <div class="col-lg-6 col-5 text-right">
                <a href="{{ route('good.index') }}" class="btn btn-sm btn-neutral">Semua Data <i class="fa fa-home fa-sm"></i></a>
                        ...
                        <form wire:submit.prevent="saveOrigin" autocomplete="off">
                            ...
                            <div class="px-lg-2">
                                <div class="row">
                                    ...
                                    <div class="form-group{{ $errors->has('items') ? ' has-danger' : '' }} col-md-6 px-2 mb-2">
                                ...
                                <div class="text-right">
                                    <a href="{{ route('good.index') }}" class="btn btn-danger mt-2">{{ __('Batal') }}</a>
