    ...
    <div class="container-fluid mt--9">
        <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
                <h6 class="h2 text-white d-inline-block mb-0">Goods</h6>
            ...
            <div class="col-lg-6 col-5 text-right">
                <a href="{{ route('good.create') }}" class="btn btn-sm btn-neutral">New <i class="fa fa-plus fa-sm"></i></a>
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            <thead class="thead-light">
                                <tr>
                                    <th scope="col" class="sort" data-sort="name">No PL</th>
                                    <th scope="col" class="sort" data-sort="name">Alamat Asal</th>
                            ...
                            <tbody class="list">
                                @foreach ($items as $item)
                                    <tr>
                                        ...
                                        <td class="text-left">
                                            <a href="{{ route('origin.edit', $item->id) }}" class="btn btn-warning">
                                                <i class="fa fa-pen"></i>
                                            </a>
                                            <button class="btn btn-danger btn" wire:click="deleteGood({{$item->id}})">
