    ...
    <div class="container-fluid mt--9">
        <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
                <a href="{{ route('item.create') }}" class="btn btn-sm btn-neutral">New <i class="fa fa-plus fa-sm"></i></a>
                        ...
                        <table class="table align-items-center table-flush">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col" class="sort" data-sort="name">Tipe</th>
                                ...
                                @foreach ($items as $item)
                                    <tr>
                                        ...
                                        <td class="text-left">
                                            ...
                                            <button class="btn btn-danger btn" wire:click="deleteItem({{$item->id}})">
